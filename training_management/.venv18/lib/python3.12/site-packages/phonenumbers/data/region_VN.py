...
PHONE_METADATA_VN = PhoneMetadata(id='VN', country_code=84, international_prefix='00',
    general_desc=PhoneNumberDesc(national_number_pattern='[12]\\d{9}|[135-9]\\d{8}|[16]\\d{6,7}|7\\d{6}', possible_length=(7, 8, 9, 10)),
    ...
    uan=PhoneNumberDesc(national_number_pattern='[17]99\\d{4}|69\\d{5,6}', example_number='1992000', possible_length=(7, 8)),
    ...
    intl_number_format=[NumberFormat(pattern='(\\d{4})(\\d{4,6})', format='\\1 \\2', leading_digits_pattern=['1(?:2[02]|[89])']),
