...
PHONE_METADATA_MW = PhoneMetadata(id='MW', country_code=265, international_prefix='00',
    ...
    fixed_line=PhoneNumberDesc(national_number_pattern='1[2-9]\\d{5}', example_number='1234567', possible_length=(7,)),
    mobile=PhoneNumberDesc(national_number_pattern='111\\d{6}|(?:2[12]|31|77|[89][89])\\d{7}', example_number='991234567', possible_length=(9,)),
    national_prefix='0',
    ...
    number_format=[NumberFormat(pattern='(\\d)(\\d{3})(\\d{3})', format='\\1 \\2 \\3', leading_digits_pattern=['1[2-9]'], national_prefix_formatting_rule='0\\1'),
        NumberFormat(pattern='(\\d{3})(\\d{2})(\\d{2})(\\d{2})', format='\\1 \\2 \\3 \\4', leading_digits_pattern=['[1-37-9]'], national_prefix_formatting_rule='0\\1')])
