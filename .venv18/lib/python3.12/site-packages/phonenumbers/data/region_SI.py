...
PHONE_METADATA_SI = PhoneMetadata(id='SI', country_code=386, international_prefix='00|10(?:22|66|88|99)',
    ...
    mobile=PhoneNumberDesc(national_number_pattern='65(?:[178]\\d|5[56]|6[01])\\d{4}|(?:[37][01]|4[013]|51|6[489])\\d{6}', example_number='31234567', possible_length=(8,)),
    ...
    number_format=[NumberFormat(pattern='(\\d{2})(\\d{3,6})', format='\\1 \\2', leading_digits_pattern=['8[09]|9'], national_prefix_formatting_rule='0\\1'),
        ...
        NumberFormat(pattern='(\\d{2})(\\d{3})(\\d{3})', format='\\1 \\2 \\3', leading_digits_pattern=['[37][01]|4[013]|51|6'], national_prefix_formatting_rule='0\\1'),
